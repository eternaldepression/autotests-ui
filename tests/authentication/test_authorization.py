...
class TestAuthorization:
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill(email='user.name@gmail.ru', username='username', password='password')
        ...
        login_page.login_form_component.fill(email='user.name@gmail.ru', password='password')
